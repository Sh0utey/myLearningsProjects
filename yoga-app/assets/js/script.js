...
(() => {
  if (localStorage.exercices) {
    exerciseArray = JSON.parse(localStorage.exercices);
  } else {
...
class Exercice {
  ...
  updateCountdown() {
    ...
    return (main.innerHTML = `
      <div class="exercice-container">
        ...
        <img src="../assets/images/${exerciseArray[this.index].pic}.png" />
  ...
  ring() {
    ...
    audio.src = "../assets/sound/ring.mp3";
    audio.play();
  }
}
...
const utils = {
  ...
  store: function () {
    localStorage.exercices = JSON.stringify(exerciseArray);
  },
};
...
const page = {
  lobby: function () {
    let mapArray = exerciseArray
      .map((exo) => {
        ...
        <li>
          ...
          <img src="../assets/images/${exo.pic}.png" />
    ...
    utils.pageContent(
      "Paramétrages <i id='reboot' class='fas fa-undo'></i>",
      "<ul>" + mapArray + "</ul>",
